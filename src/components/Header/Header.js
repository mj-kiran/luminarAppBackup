...
function Header() {
  ...
  const [activeLink, setActiveLink] = useState("batches");
    ...
    <>
      <Navbar className="navbar fixed-top" bg="light" data-bs-theme="light">
        <Nav className="navbar_headings me-auto ">
          <Nav.Link
            className={
              activeLink === "batches" ? "nav_button active" : "nav_button"
            }
            onClick={() => {
          ...
          <Nav.Link
            className={
              activeLink === "timetable" ? "nav_button active" : "nav_button"
            }
            onClick={() => {
          ...
          <Nav.Link
            className={
              activeLink === "enquiry" ? "nav_button active" : "nav_button"
            }
            onClick={() => {
          ...
          <Nav.Link
            className={
              activeLink === "payments" ? "nav_button active" : "nav_button"
            }
            onClick={() => {
          ...
          <Nav.Link
            className={
              activeLink === "chats" ? "nav_button active" : "nav_button"
            }
            onClick={() => {
          ...
          <Nav.Link
            className={
              activeLink === "appdownloads" ? "nav_button active" : "nav_button"
            }
            onClick={() => {
          ...
          <Nav.Link
            className={
              activeLink === "store" ? "nav_button active" : "nav_button"
            }
            onClick={() => {
          ...
          <Nav.Link
            className={
              activeLink === "couponcode" ? "nav_button active" : "nav_button"
            }
            onClick={() => {
        ...
        <div className="luminar_logo_section">
          <img
